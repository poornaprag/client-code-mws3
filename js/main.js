...
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  fetchNeighborhoods();
  fetchCuisines();
  registerServiceWorker(); // Register service worker (swap) needs to be called after map init.
...
/**
 * for caching static and dynamic assets 
 */
...
const syncFavoriteRestaurantsWithServer = () => {
  Promise.all(restaurantsToBeSynced.map(restaurant => {
    ...
    console.log('Faves backgroud sync');
